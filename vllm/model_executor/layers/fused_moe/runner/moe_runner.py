...
class MoERunner(MoERunnerInterface):
    ...
    def _apply_quant_method(
        ...
        # becoming resident. SharedExperts queues a consumer-stream wait before
        # returning, so the shared expert can overlap the already-submitted gate
        # work but is complete before a resident routed kernel is launched.
        self._maybe_apply_shared_experts(
            shared_experts_input,
