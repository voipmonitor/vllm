    ...
    def _run_b12x_gdn_decode_post_conv(
        ...
        *,
        ...
        cache = forward_context.additional_kwargs.setdefault(
            "b12x_qwen_gdn_metadata_tensors", {}
        )
        cache_key = (
            id(metadata),
            num_input_tokens,
        ...
        if bound_metadata is None:
            ...
            accepted_tokens = (
                self._b12x_num_accepted_tokens[:num_requests]
                if num_accepted_tokens is None
                else num_accepted_tokens[:num_requests]
            )
